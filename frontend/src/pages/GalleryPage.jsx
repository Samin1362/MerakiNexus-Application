...
//       const mediumMatch = artwork.medium
//         ?.toLowerCase()
...
//                     ${Number(art.art_value_usd).toLocaleString()}
//                   </div>
          ...
          {selected && (
            <div className="space-y-6">
              ...
              {selected.tags && selected.tags.length > 0 && (
                <div className="p-4 bg-white/5 rounded-xl">
                  <h3 className="text-lg font-semibold mb-3">AI Classification Tags</h3>
                  <div className="flex flex-wrap gap-2">
                    {selected.tags.map((tag, index) => (
                      <div
                        key={index}
                        className="px-3 py-2 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 text-purple-200 text-sm rounded-full border border-purple-400/30 flex items-center gap-2"
                      >
